...
public class Event extends AbstractModel {
	 ...
	 *  @return 0 on success
	 */
	public int isValidName(String name) throws WPISuiteException{
	 ...
	 *  @return 0 on success
	 */
	public int isValidLocation(String location) throws WPISuiteException{
	 ...
	 * @return 0 on success
	 */
	public int isValidDescription(String desc) throws WPISuiteException{
	 ...
	 * @return 0 on success
	 */
	public int isValidDate(Calendar cal) throws WPISuiteException{
	 ...
	 * @return 0 on success
	 */
	public int isValidDateOrder(Calendar startDate, Calendar endDate) throws WPISuiteException{
