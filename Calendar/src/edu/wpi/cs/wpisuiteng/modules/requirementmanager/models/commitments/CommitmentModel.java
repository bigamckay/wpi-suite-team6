...
//	public Commitment getConflictingCommitment(Date start, Date end) {
...
//			boolean startGreaterOrEqual = (start.after(comit.getEnd().getDate()) || start.equals(comit.getEnd().getDate()));
//			boolean endLessThanOrEqual = (end.before(comit.getStart().getDate()) || end.equals(comit.getStart().getDate()));
//			
...
//			
//			boolean startValid = comit2.getStart().getDate().before(date) || comit2.getStart().getDate().equals(date);
//			boolean endValid = comit2.getEnd().getDate().after(date) || comit2.getEnd().getDate().equals(date);
//
